 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.gACL.impl.DetailCodeImpl#getStmts <em>Stmts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DetailCodeImpl extends MinimalEObjectImpl.Container implements DetailCode
{
  ...
  {
    return GACLPackage.Literals.DETAIL_CODE;
  }
  ...
  public EList<Statement> getStmts()
  {
    if (stmts == null)
    {
      stmts = new EObjectContainmentEList<Statement>(Statement.class, this, GACLPackage.DETAIL_CODE__STMTS);
    }
    return stmts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GACLPackage.DETAIL_CODE__STMTS:
