 ...
 * introduced subclass. 
 */
public class GACLActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(GACLActivator.class);
	...
	private static GACLActivator INSTANCE;
	
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_GACL = "org.xtext.example.mydsl.GACL";
	...
	public static GACLActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (ORG_XTEXT_EXAMPLE_MYDSL_GACL.equals(grammar)) {
			return new org.xtext.example.mydsl.GACLRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (ORG_XTEXT_EXAMPLE_MYDSL_GACL.equals(grammar)) {
			return new org.xtext.example.mydsl.ui.GACLUiModule(this);
		}
